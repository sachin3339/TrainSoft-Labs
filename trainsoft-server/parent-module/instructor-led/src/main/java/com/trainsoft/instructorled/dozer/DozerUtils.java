package com.trainsoft.instructorled.dozer;
...
public class DozerUtils {
    ...
    public <T> T convert(Object srcObject, Class<T> destnationObj){
        try{
            ...
            logger.error("while converting source to destination, throwing error",exception);
            return null;
        }
    }
    ...
    public <T, U> List<T> convertList(List<U> srcObjects, Class<T> destnationObjClass,String mapId){
        ...
        try {
            ...
            logger.error("while converting list of source to list of destination, throwing error",e);
        }
        return list;
    }
