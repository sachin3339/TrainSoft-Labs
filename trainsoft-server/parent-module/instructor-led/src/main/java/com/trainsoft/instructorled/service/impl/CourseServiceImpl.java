...
public class CourseServiceImpl implements ICourseService {
    ...
    public List<CourseTO> getCourses() {
        try {
            ...
            return mapper.convertList(courses, CourseTO.class);
        }catch (Exception e) {
    ...
    public CourseSessionTO createSession(CourseSessionTO courseSessionTO) {
        ...
        try {
            if (StringUtils.isNotEmpty(course.getStringSid())) {
                ...
                return mapper.convert(courseSession,CourseSessionTO.class);
            } else
                throw new RecordNotFoundException();
        } catch (Exception e) {
    ...
    public List<CourseSessionTO> findCourseSessionByCourseSid(String courseSid) {
        ...
        try{
            if(StringUtils.isNotEmpty(course.getStringSid())){
                ...
                return  mapper.convertList(courseSessions,CourseSessionTO.class);
            }else
                throw new RecordNotFoundException();
        }catch(Exception e) {
