...
import { ICN_ASSESSMENT, ICN_CLOSE, ICN_EDIT, ICN_EXIT, ICN_MIC, ICN_PEOPLE, ICN_PRESENT, ICN_RECORD, ICN_SCREEN_SHARE, ICN_SEND, ICN_VIDEO } from '../../Constant/Icon';
import { CustomToggle } from '../../Services/MethodFactory';
import { Dropdown } from 'react-bootstrap';
import { BtnRound, Button } from '../../Components/Buttons/Buttons'
            ...
            <div className="flx full-w full-h ">
                ...
                <div className="flx1 ml-3 column">
                    <div className="jcb">
                        ...
                        <BsDropDown 
                        header={<div className="action-btn">
                            {ICN_ASSESSMENT}
                        </div>}>
